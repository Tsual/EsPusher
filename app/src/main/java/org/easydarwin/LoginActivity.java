...
import org.easydarwin.util.LoginUser;
import org.easydarwin.util.PostUtil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                in.setClassName( getApplicationContext(), "org.easydarwin.RegistActivity" );
                startActivity( in );
        ...
        public void handleMessage(Message message) {
            ...
            try {
                ...
                if ("Error".equals(json.getString("excuteResult"))) {
                    ...
                    Intent in = new Intent();
                    in.setClassName( getApplicationContext(), ".SplashActivity" );
                    startActivity( in );
                }
            } catch (Exception ex) {
